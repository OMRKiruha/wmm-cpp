...
namespace wmm {
    struct Ellipsoid {
        ...
        static constexpr double K0R4   = 6367449.1458234153093 * K0;
        static constexpr double K0R4oa = K0R4 / 6378137;
        static constexpr std::array Acoeff{
            8.37731820624469723600E-04, 7.60852777357248641400E-07, 1.19764550324249124400E-09, 2.42917068039708917100E-12,
            5.71181837042801392800E-15, 1.47999793137966169400E-17, 4.10762410937071532000E-20, 1.21078503892257704200E-22};
    };
}  // namespace wmm
